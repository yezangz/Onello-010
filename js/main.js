    (function () {
      ...
      function initPetalFall() {
        ...
        function createPetal() {
          ...
          petal.src = 'assets/images/screenshot_196_316.webp';
          petal.alt = '飘落花瓣';
      ...
      /* ===== 3.9 Project 区块提示文字打字效果 ===== */
      function startProjectHintTyping() {
        const hint = $('#projectHintText');
        if (!hint) return;
        const text = '请尝试点击文件查看更多作品详情';
        hint.textContent = '';
        hint.classList.add('typing');
        let i = 0;
        const step = 90; // ms per character
        function typeChar() {
          if (i <= text.length) {
            ...
            if (i <= text.length) {
              ...
              hint.classList.remove('typing');
              hint.classList.add('typing-done');
              // 打字结束后光标再闪烁 3 秒，然后隐藏光标
              setTimeout(() => {
                hint.classList.add('caret-hidden');
              }, 3000);
            }
          }
        }
      ...
      function initEndingStars() {
        ...
        for (let i = 0; i < STAR_COUNT; i += 1) {
          ...
          img.src = 'assets/images/screenshot_272_472.webp';
          img.alt = '星光';
          img.draggable = false;
